<script>
    $(document).ready(function () {
        ...
        var table1 = $('#daftar_data_1').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Pembelian Item', $data) }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            ...
            buttons: [{
                ...
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Pembelian Item Create', $data) }}";
                },
        ...
        var table2 = $('#daftar_data_2').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Pembelian Pembayaran', $data) }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            ...
            buttons: [{
                ...
                text: 'Tambah Data',
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Pembelian Pembayaran Create', $data) }}";
                },
                init: function (api, node, config) {
                    $(node).removeClass('btn-default')
                }
