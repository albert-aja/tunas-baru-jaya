<script>
    $(document).ready(function () {
        ...
        var table1 = $('#daftar_data_1').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Supplier') }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            pageLength: 10,
            dom: '<"columns row"<"column col-sm-6"l><"column col-sm-6 text-right"{{ (Auth::user()->can("Menambah Supplier") ? "B" : "") }}>>,' +
            ...
            buttons: [{
                ...
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Supplier Create') }}";
                },
