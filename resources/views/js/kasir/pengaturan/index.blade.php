<script>
    $(document).ready(function () {
        var table2 = $('#daftar_data_2').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Pengaturan Produk Jenis Koreksi') }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            ...
            buttons: [{
                ...
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Pengaturan Produk Jenis Koreksi Create') }}";
                },
        ...
        var table3 = $('#daftar_data_3').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Pengaturan Produk Kategori') }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            ...
            buttons: [{
                ...
                text: 'Tambah Data',
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Pengaturan Produk Kategori Create') }}";
                },
                init: function (api, node, config) {
                    $(node).removeClass('btn-default')
                }
        ...
        var table4 = $('#daftar_data_4').DataTable({
            ...
            "serverSide": true,
            "ordering": false,
            "ajax": "{{ route('Kasir Tabel Pengaturan Produk Satuan') }}",
            lengthMenu: [
                [5, 10, 25, 100, -1],
                [5, 10, 25, 100, "All"]
            ],
            ...
            buttons: [{
                ...
                text: 'Tambah Data',
                action: function (e, dt, node, config) {
                    document.location.href = "{{ route('Kasir Pengaturan Produk Satuan Create') }}";
                },
                init: function (api, node, config) {
                    $(node).removeClass('btn-default')
                }
