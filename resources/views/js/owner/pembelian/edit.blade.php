<script>
    $(document).ready(function () {
        ...
        $('#FormSuntingPembelian').on('submit', (function (e) {
            e.preventDefault();
            ...
            if (!waktu_transaksi || !no_faktur) {
                ...
                $.ajax({
                    type: "post",
                    dataType: 'JSON',
                    url: "{{ route('Owner Pembelian Update', $data) }}",
                    ...
                    success: function (data) {
                        if (data.status == 'Valid') {
                            swal({
                                title: 'Berhasil',
                                text: "Pembelian berhasil disunting.",
                                icon: 'success',
                                button: "Lanjutkan"
                            }).then(function () {
                                document.location.href = "{{ route('Owner Pembelian Show', $data) }}";
                            })
                        } else {
