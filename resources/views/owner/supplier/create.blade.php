...
<section class="content">
    <div class="box box-blue">
        ...
        <form class="form-horizontal" id="FormTambahSupplier" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
            ...
            {!! FormHelp::form_footer(route('Owner Supplier')) !!}
        </form>
    </div>
</section>
@endsection
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Owner Supplier Create') }}
@endpush

@push('page_scripts')
    @include('js.owner.supplier.create')
@endpush
