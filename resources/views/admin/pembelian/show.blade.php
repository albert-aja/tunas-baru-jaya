...
<section class="content">
    <div class="box box-blue">
        ...
        {!! GeneralHelp::get_default_show_footer($data, array((Auth::user()->can("Mengubah Pembelian") ? 1 : 0),(Auth::user()->can("Menghapus Pembelian") ? 1 : 0),1), route('Admin Pembelian Edit', $data), route('Admin Pembelian Destroy'), route('Admin Pembelian'), 'Anda yakin ingin menghapus pembelian ini?') !!}
    </div>
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Pembelian Show', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.pembelian.show')
@endpush
