...
<section class="content">
    <div class="box box-blue">
        ...
        <form class="form-horizontal" id="FormSuntingCustomer" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
            ...
            {!! FormHelp::form_footer(route('Admin Customer Show', $data)) !!}
        </form>
    </div>
</section>
@endsection
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Customer Edit', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.customer.edit')
@endpush
