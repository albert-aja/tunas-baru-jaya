    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-green">
                ...
                <a href="{{ route('Admin Customer') }}" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-yellow">
                ...
                <a href="{{ route('Admin Pembelian') }}" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <div class="col-lg-3 col-xs-6">
            <div class="small-box bg-red">
                ...
                <a href="{{ route('Admin Penjualan') }}" class="small-box-footer">Selengkapnya <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
...
@push('page_scripts')
    @include('js.admin.beranda.index')
    <script>
