...
<section class="content">
    <div class="box box-blue">
        ...
        <form class="form-horizontal" id="FormTambahPenjualanPembayaran" enctype="multipart/form-data">
            ...
            {!! FormHelp::form_footer(route('Admin Pembelian Show', $data)) !!}
        </form>
    </div>
</section>
@endsection
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Penjualan Pembayaran Create', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.penjualan.pembayaran.create')
@endpush
