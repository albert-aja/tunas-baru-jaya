...
<section class="content">
    <div class="box box-blue">
        ...
        <div class="box-body">
            <table class="table">
                ...
                <tr>
                    <th>Faktur</th>
                    <td>
                        <a href="{{ route('Admin Penjualan Faktur', $data) }}" class="btn btn-primary btn-sm" target="_blank">Lihat</a>
                    </td>
                </tr>
                <tr>
                    <th>Keterangan</th>
        ...
        {!! GeneralHelp::get_default_show_footer($data, array((Auth::user()->can("Mengubah Penjualan") ? 1 : 0),(Auth::user()->can("Menghapus Penjualan") ? 1 : 0),1), route('Admin Penjualan Edit', $data), route('Admin Penjualan Destroy'), route('Admin Penjualan'), 'Anda yakin ingin menghapus penjualan ini?') !!}
    </div>
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Penjualan Show', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.penjualan.show')
@endpush
