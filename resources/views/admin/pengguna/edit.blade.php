...
<section class="content">
    <div class="box box-blue">
        ...
        <form class="form-horizontal" id="FormSuntingPengguna" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
                {!! FormHelp::select(1, 'config_roles', 'id', array('name'), '$0$', 'Level Akses', 'role', 'Level Akses', str_replace('"', '', str_replace('[', '', str_replace(']', '', $data->getRoleId()))), 'id != ""') !!}
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Admin Pengguna Edit', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.admin.pengguna.edit')
@endpush
