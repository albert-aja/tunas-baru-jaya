    ...
    <div class="row">
        <div class="col-sm-9">
            <div class="box box-blue">
                ...
                <form class="form-horizontal" id="FormTambahPembelian" enctype="multipart/form-data">
                    @csrf
                    <div class="box-body">
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Kasir Pembelian Create') }}
@endpush

@push('page_scripts')
    @include('js.kasir.pembelian.create')
@endpush
