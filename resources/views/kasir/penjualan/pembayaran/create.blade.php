...
<section class="content">
    <div class="box box-blue">
        ...
        <form class="form-horizontal" id="FormTambahPenjualanPembayaran" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
            ...
            {!! FormHelp::form_footer(route('Kasir Pembelian Show', $data)) !!}
        </form>
    </div>
</section>
@endsection
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Kasir Penjualan Pembayaran Create', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.kasir.penjualan.pembayaran.create')
@endpush
