    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box box-blue">
                ...
                {!! GeneralHelp::get_default_show_footer($data, array((Auth::user()->can("Mengubah Produk") ? 1 : 0),(Auth::user()->can("Menghapus Produk") ? 1 : 0),1), route('Kasir Produk Edit', $data), route('Kasir Produk Destroy'), route('Kasir Produk'), 'Anda yakin ingin menghapus produk ini?') !!}
            </div>
        </div>
...
@push('breadcrumbs')
    {{ Breadcrumbs::render('Kasir Produk Show', $data->id) }}
@endpush

@push('page_scripts')
    @include('js.kasir.produk.show')
@endpush
