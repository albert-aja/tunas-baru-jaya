...
class BlameableServiceProvider extends ServiceProvider
{
    ...
    public function registerMacroHelpers()
    {
        Blueprint::macro('blameable', function () {
            $this->uuid(Config::get('blameable.column_names.createdByAttribute', 'created_by'))->nullable();
            $this->uuid(Config::get('blameable.column_names.updatedByAttribute', 'updated_by'))->nullable();
            $this->uuid(Config::get('blameable.column_names.deletedByAttribute', 'deleted_by'))->nullable();
        });
    }
