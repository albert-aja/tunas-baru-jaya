...
class Penjualan extends Controller
{
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Penjualan") ? '<a href="' . route('Admin Penjualan Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
    ...
    {
        $data = ModelsPenjualan::findOrFail($id);
        return view('admin.penjualan.item.create', compact('data'));
    }
    ...
    public function item_destroy(Request $request, $id)
    {
        ...
        $link = route('Admin Penjualan Show', ['id' => $data->penjualan]);
    ...
    public function dt_item($id)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Penjualan") ? '<TombolHapus url="' . route('Admin Penjualan Item Destroy', ['id' => $data->penjualan]) . '" pertanyaan="Anda yakin ingin menghapus produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
    ...
    {
        $data = ModelsPenjualan::findOrFail($id);
        return view('admin.penjualan.pembayaran.create', compact('data'));
    }
    ...
    public function pembayaran_destroy(Request $request, $id)
    {
        ...
        $link = route('Admin Penjualan Show', ['id' => $id]);
    ...
    public function dt_pembayaran($id)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Penjualan") ? '<TombolHapus url="' . route('Admin Penjualan Pembayaran Destroy', ['id' => $data->penjualan]) . '" pertanyaan="Anda yakin ingin menghapus pembayaran ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->escapeColumns([])
            ->make(true);
    }
