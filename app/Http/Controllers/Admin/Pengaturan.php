...
class Pengaturan extends Controller
{
    ...
    public function edit_izin_level_akses($id)
    {
        ...
        return view('admin.pengaturan.izin-level-akses.edit', compact('role', 'permission'));
    }
    ...
    public function dt_izin_level_akses()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '
                        <a href="' . route('Admin Pengaturan Izin Level Akses Edit', $data) . '" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>
                       ';
            })
            ->make(true);
    }
    ...
    {
        return view('admin.pengaturan.produk-kategori.create');
    }
    ...
    public function edit_produk_kategori($id)
    {
        ...
        return view('admin.pengaturan.produk-kategori.edit', compact('data'));
    }
    ...
    {
        return view('admin.pengaturan.produk-satuan.create');
    }
    ...
    public function edit_produk_satuan($id)
    {
        ...
        return view('admin.pengaturan.produk-satuan.edit', compact('data'));
    }
    ...
    {
        return view('admin.pengaturan.produk-jenis-koreksi.create');
    }
    ...
    public function edit_produk_jenis_koreksi($id)
    {
        ...
        return view('admin.pengaturan.produk-jenis-koreksi.edit', compact('data'));
    }
