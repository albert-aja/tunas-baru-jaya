...
class Pengguna extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('owner.pengguna.show', compact('data'));
    }
    ...
    {
        $data = User::findOrFail($id);
        return view('owner.pengguna.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Owner Pengguna Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
}
