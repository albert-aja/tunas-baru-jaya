...
class Supplier extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('owner.supplier.show', compact('data'));
    }
    ...
    {
        $data = ModelsSupplier::findOrFail($id);
        return view('owner.supplier.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Supplier") ? '<a href="' . route('Owner Supplier Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
}
