...
class Produk extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('kasir.produk.show', compact('data'));
    }
    ...
    {
        $data = ModelsProduk::findOrFail($id);
        return view('kasir.produk.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Produk") ? '<a href="' . route('Kasir Produk Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
    ...
    {
        $data = ModelsProduk::findOrFail($id);
        return view('kasir.produk.koreksi.create', compact('data'));
    }
    ...
    public function koreksi_destroy(Request $request, $id)
    {
        ...
        $link = route('Kasir Produk Show', $produk);
    ...
    public function dt_koreksi($id)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Menghapus Koreksi Stok Produk") ? '<TombolHapus url="' . route('Kasir Produk Koreksi Destroy', ['id' => $data->produk]) . '" pertanyaan="Anda yakin ingin menghapus koreksi produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
}
