...
class Supplier extends Controller
{
    ...
    {
        return view('kasir.supplier.index');
    }
    ...
    {
        return view('kasir.supplier.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('kasir.supplier.show', compact('data'));
    }
    ...
    {
        $data = ModelsSupplier::findOrFail($id);
        return view('kasir.supplier.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Supplier") ? '<a href="' . route('Kasir Supplier Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
}
