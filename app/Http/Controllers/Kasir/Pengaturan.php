...
class Pengaturan extends Controller
{
    ...
    {
        return view('kasir.pengaturan.index');
    }
    ...
    public function edit_izin_level_akses($id)
    {
        ...
        return view('kasir.pengaturan.izin-level-akses.edit', compact('role', 'permission'));
    }
    ...
    public function dt_izin_level_akses()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '
                        <a href="' . route('Kasir Pengaturan Izin Level Akses Edit', $data) . '" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>
                       ';
            })
            ->make(true);
    }
    ...
    {
        return view('kasir.pengaturan.produk-kategori.create');
    }
    ...
    public function edit_produk_kategori($id)
    {
        ...
        return view('kasir.pengaturan.produk-kategori.edit', compact('data'));
    }
    ...
    public function dt_produk_kategori()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Kategori Produk") ? '<a href="' . route('Kasir Pengaturan Produk Kategori Edit', $data) . '" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>' : '') . ' ' . (Auth::user()->can("Menghapus Kategori Produk") ? '<TombolHapus url="' . route('Kasir Pengaturan Produk Kategori Destroy') . '" pertanyaan="Anda yakin ingin menghapus kategori produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
    ...
    {
        return view('kasir.pengaturan.produk-satuan.create');
    }
    ...
    public function edit_produk_satuan($id)
    {
        ...
        return view('kasir.pengaturan.produk-satuan.edit', compact('data'));
    }
    ...
    public function dt_produk_satuan()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Satuan Produk") ? '<a href="' . route('Kasir Pengaturan Produk Satuan Edit', $data) . '" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>' : '') . ' ' . (Auth::user()->can("Menghapus Satuan Produk") ? '<TombolHapus url="' . route('Kasir Pengaturan Produk Satuan Destroy') . '" pertanyaan="Anda yakin ingin menghapus satuan produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
    ...
    {
        return view('kasir.pengaturan.produk-jenis-koreksi.create');
    }
    ...
    public function edit_produk_jenis_koreksi($id)
    {
        ...
        return view('kasir.pengaturan.produk-jenis-koreksi.edit', compact('data'));
    }
    ...
    public function dt_produk_jenis_koreksi()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Jenis Koreksi Stok Produk") ? '<a href="' . route('Kasir Pengaturan Produk Jenis Koreksi Edit', $data) . '" class="btn btn-xs btn-success"><i class="fas fa-edit"></i></a>' : '') . ' ' . (Auth::user()->can("Menghapus Jenis Koreksi Stok Produk") ? '<TombolHapus url="' . route('Kasir Pengaturan Produk Jenis Koreksi Destroy') . '" pertanyaan="Anda yakin ingin menghapus jenis koreksi produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
}
