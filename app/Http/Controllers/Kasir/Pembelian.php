...
class Pembelian extends Controller
{
    ...
    {
        return view('kasir.pembelian.index');
    }
    ...
    {
        return view('kasir.pembelian.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('kasir.pembelian.show', compact('data'));
    }
    ...
    {
        $data = ModelsPembelian::findOrFail($id);
        return view('kasir.pembelian.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ->addColumn('supplier', function ($data) {
                return ($data->supplier != '' ? $data->get_supplier->nama : '');
            })
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Pembelian") ? '<a href="' . route('Kasir Pembelian Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
    ...
    {
        $data = ModelsPembelian::findOrFail($id);
        return view('kasir.pembelian.item.create', compact('data'));
    }
    ...
    public function item_destroy(Request $request, $id)
    {
        ...
        $link = route('Kasir Pembelian Show', ['id' => $data->pembelian]);
    ...
    public function dt_item($id)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Pembelian") ? '<TombolHapus url="' . route('Kasir Pembelian Item Destroy', ['id' => $data->pembelian]) . '" pertanyaan="Anda yakin ingin menghapus produk ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->make(true);
    }
    ...
    {
        $data = ModelsPembelian::findOrFail($id);
        return view('kasir.pembelian.pembayaran.create', compact('data'));
    }
    ...
    public function pembayaran_destroy(Request $request, $id)
    {
        ...
        $link = route('Kasir Pembelian Show', ['id' => $id]);
    ...
    public function dt_pembayaran($id)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Mengubah Pembelian") ? '<TombolHapus url="' . route('Kasir Pembelian Pembayaran Destroy', ['id' => $data->pembelian]) . '" pertanyaan="Anda yakin ingin menghapus pembayaran ini?" parameter="id" value="' . $data->id . '" class="btn btn-xs btn-danger"><i class="fas fa-trash"></i></TombolHapus>' : '');
            })
            ->escapeColumns([])
            ->make(true);
    }
