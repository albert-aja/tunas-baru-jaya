...
class Customer extends Controller
{
    ...
    {
        return view('kasir.customer.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('kasir.customer.show', compact('data'));
    }
    ...
    {
        $data = ModelsCustomer::findOrFail($id);
        return view('kasir.customer.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ->addColumn('action', function ($data) {
                return (Auth::user()->can("Melihat Customer") ? '<a href="' . route('Kasir Customer Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>' : '');
            })
            ->make(true);
    }
}
