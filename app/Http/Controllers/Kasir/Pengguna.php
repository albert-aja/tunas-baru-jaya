...
class Pengguna extends Controller
{
    ...
    {
        return view('kasir.pengguna.index');
    }
    ...
    {
        return view('kasir.pengguna.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('kasir.pengguna.show', compact('data'));
    }
    ...
    {
        $data = User::findOrFail($id);
        return view('kasir.pengguna.edit', compact('data'));
    }
    ...
    public function dt()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($data) {
                return '<a href="' . route('Kasir Pengguna Show', $data) . '" class="btn btn-xs btn-primary"><i class="fas fa-search"></i></a>';
            })
            ->make(true);
    }
}
